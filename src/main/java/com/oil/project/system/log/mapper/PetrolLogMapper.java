package com.oil.project.system.log.mapper;
 ...
 * @date 2020-11-04
 */
public interface PetrolLogMapper 
{
    /**
     * 查询加油采购入库记录
     * 
    ...
    PetrolLog selectPetrolLogByLogId(Long logId);

    int updatePetrolLogByLogId(PetrolLog petrolLog);
}
